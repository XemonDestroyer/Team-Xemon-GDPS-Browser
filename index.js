...
app.use(async function(req, res, next) {
  ...
  let subdomains = req.subdomains.map(x => x.toLowerCase())
   subdomains.splice(subdomains.length - 2, 2); // removes 2 last subdomains (repo.username for replit)
  ...
  req.gdRequest = function(target, params={}, cb=function(){}) {
    ...
    if (params.forceGD || (params.form && params.form.forceGD)) endpoint = "https://www.boomlings.com/database/"
